    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card card-body border p-4 h-100">
                ...
                <h2 class="text-warning"> {{ $avialableTrajet }} </h2>
                <p class="mb-2"><span class="text-success me-1"> {{ $avialableTrajet }} </span>Trajets Disponible</p>
                <div class="mt-auto text-primary-hover"><a href="#"
            ...
            <div class="card border">
                ...
                <div class="card-header border-bottom">
                    <h5 class="card-header-title">Vos Trajets<span
                            class="badge bg-primary bg-opacity-10 text-primary ms-2">{{ $countTrajet }} Trajets au
                            total</span></h5>
                </div>
                ...
                <div class="card-body vstack gap-3">
                    ...
                    @if ($trajets->isEmpty())
                        <p class="text-center text-black" style="font-size: 20px">Vous n'avez publier aucun trajet pour le
                            moment.</p>
                    @else
                            ...
                            <div class="card border p-2">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-3 col-lg-2">
                                        <img src="{{ asset('Trajets/' . $trajet->image) }}" class="card-img rounded-2"
                                    ...
                                    <div class="col-md-9 col-lg-10">
                                        <div class="card-body position-relative d-flex flex-column p-0 h-100">
                                            ...
                                            <!-- Title -->
                                            <h5 class="card-title mb-0 me-5"><a href="#">{{ $trajet->point_depart }} -
                                                    {{ $trajet->destination }} </a></h5>
