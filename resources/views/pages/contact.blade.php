		...
		<div class="row g-4">
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-body shadow text-center align-items-center h-100">
					...
					<div class="d-grid gap-3 d-sm-block">
						<button class="btn btn-sm btn-primary-soft"><i class="bi bi-phone me-2"></i>(+237) 655 299 168</button> <br>
						<button class="btn btn-sm btn-light"><i class="bi bi-telephone me-2"></i>(+237)653 335 285</button>
					</div>
				</div>
			</div>
			<!-- Contact item END -->
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-body shadow text-center align-items-center h-100">
					...
					<!-- Buttons -->
					<a href="#" class="btn btn-link text-decoration-underline p-0 mb-0"><i class="bi bi-envelope me-1"></i>contact@matua.cm</a>
				</div>
			</div>
			<!-- Contact item END -->
						...
						<form class="row g-4">
							...
							<div class="col-12 form-check ms-2">
								...
								<label class="form-check-label" for="exampleCheck1">
									En soumettant ce formulaire vous acceptez de faire partie de notre newlestter.
								</label>
							</div>
							<!-- Button -->
							<div class="col-12">
								<button class="btn btn-dark mb-0" type="button">Envoyer</button>
							</div>	
						</form>
					</div>
					<!-- Card body END -->
